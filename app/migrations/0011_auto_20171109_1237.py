    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_website', models.URLField(blank=True, default='https://github.com/julianpalladino/WebODM/', help_text='The website URL of your organization', max_length=255, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Theme',
